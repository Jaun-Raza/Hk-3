...
const page = () => {
  return (
    <main>
      ...
      {/* contact info */}
      <div className="flex flex-col gap-10 md:gap-1  w-full h-[1400px] md:h-[1144px] top-[416px]   ">
        <div>
          {/* headings */}
        ...
        <div className="flex flex-col pl-5  w-[99%] md:flex-row md:h-[800px] top-[637px] left-[191px] md:items-center justify-around    ">
          {/* left side  */}
